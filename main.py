...
def create_project(phoneNumber,projectTitle):
    ...
    driver.find_element("xpath", "(//input[@type='tel'])[4]").send_keys("1")
    sleep(5)
    create_project_page = driver.find_element("xpath","//a[@href='/ar/create-form']")
    ...
    driver.find_element("xpath","//h6[text()='تأييد المكان المختار']").click()
    sleep(1)
    more_detailes = driver.find_element("xpath","//span[text()='تفاصيل أكثر']")
    more_detailes.click()
    sleep(30)
    driver.execute_script("window.scrollTo(0, document.body.scrollHeight);")
    sleep(1)
    ...
    sleep(1)
    driver.execute_script("window.scrollTo(0, document.body.scrollHeight);")
    other_subject = driver.find_element("xpath","(//input[@id='radio'])[15]")
    other_subject.click()
    sleep(1)
    other_subject_description = driver.find_element("xpath","(//textarea[@placeholder='اكتب'])[2]")
    other_subject_description.send_keys("موضوع تستی")
    sleep(1)
    driver.find_element("xpath","(//h6[text()='تأييد'])[2]").click()
    sleep(1)
    requirement_section = driver.find_element("xpath","(//div[contains(@class,'flex justify-between')])[3]")
    ...
    driver.find_element("xpath","//h6[text()='تأييد']").click()
    sleep(1)
    address = driver.find_element("xpath","(//input[@placeholder='اكتب'])[2]")
    ...
    sleep(1)
    gender_section = driver.find_element("xpath", "//h6[text()='الجنس']")
    ...
    driver.find_element("xpath","(//h6[text()='تأييد'])[2]").click()
    sleep(5)
    project_profile_page = driver.find_element("xpath","//p[text()='حساب المشروع']")
    project_profile_page.click()
    sleep(3)
    dom = driver.page_source
    assert projectTitle in dom

create_project("89196549828","پروژه تست وب 12 مهر 2")
